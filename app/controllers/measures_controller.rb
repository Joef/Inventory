class MeasuresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @measure.save
        format.html { redirect_to measures_path, notice: "Measure #{@measure.name} was successfully created." }
  ...
  def update
    respond_to do |format|
      if @measure.update(measure_params)
        format.html { redirect_to measures_path, notice: "Updated  #{@measure.name}" }
