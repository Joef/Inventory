class InvoiceIngredientsController < ApplicationController
  ...
  private
    ...
    def invoice_ingredient_params
      params.require(:invoice_ingredient).permit(:invoice_id, :ingredient_id, :measure_id, :quantity_ordered, :quantity_shipped, :price, :extended, :brand, :item_number, :vendor_number, :description, :unit, :pack, :out_of_stock )
    end
end
